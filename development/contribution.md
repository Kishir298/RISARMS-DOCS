...
5. **Consistent terminology.** Use canonical dotted names (`C.O.R.E.`, `R.E.S.C.S.`, `A.S.I.S.`, `T.I.V.I.S.S.`, `RadarS.A.R.D.`) and directory forms in backticks (`CORE/`, `RESCS/`, `ASIS/`, `DOCS/`).
